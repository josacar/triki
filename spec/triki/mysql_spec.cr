...
describe Triki::Mysql do
  subject = Triki::Mysql.new
  ...
  describe "#make_valid_value_string" do
    it "should work with nil values" do
      value = nil
      subject.make_valid_value_string(value).should eq("NULL")
    end

    it "should work with hex-encoded blob data" do
      value = "0xACED00057372001F6A6176612E7574696C2E436F6C6C656"
      subject.make_valid_value_string(value).should eq("0xACED00057372001F6A6176612E7574696C2E436F6C6C656")
    end

    it "should quote hex-encoded ALIKE data" do
      value = "40x17x7"
      subject.make_valid_value_string(value).should eq("'40x17x7'")
    end

    it "should quote all other values" do
      value = "hello world"
      subject.make_valid_value_string(value).should eq("'hello world'")
    end
  end
