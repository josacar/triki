...
describe Triki::SqlServer do
  subject = Triki::SqlServer.new
  ...
  describe "#make_valid_value_string" do
    it "should output 'NULL' when the value is nil" do
      subject.make_valid_value_string(nil).should eq("NULL")
    end

    it "should enclose the value in quotes if it's a string" do
      subject.make_valid_value_string("something").should eq("N'something'")
    end

    it "should not enclose the value in quotes if it is a method call" do
      subject.make_valid_value_string("CAST(0x00009E1A00000000 AS DATETIME)").should eq("CAST(0x00009E1A00000000 AS DATETIME)")
    end
  end
end
